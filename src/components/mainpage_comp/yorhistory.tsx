  ...
  return (
    <div className='flex justify-center h-screen font-kanit'>
      <div className='flex flex-col justify-center'>
        ...
        <p className='ml-[10%] md:ml=0 max-w-80 md:max-w-2xl lg:max-w-4xl xl:lg:max-w-6xl text-sm md:text-xl text-neutral-300 indent-10'>เราเป็นชมรมที่เกี่ยวกับ Technology CyberSecurity เเละการ Coding เราเชื่อว่าเทคโนโลยีและการโค้ดมี perpotential ที่ยิ่งใหญ่ในการประเมินและแก้ไขปัญหาที่ท้าทายในโลกปัจจุบัน ไม่ว่าจะเป็นการพัฒนาเว็บไซต์ การสร้างแอพพลิเคชั่น หรือ การเขียนโค้ดที่ช่วยในการ Analyze data เราจึงมีความกระตือรือร้นที่จะเรียนรู้และแบ่งปันความรู้เกี่ยวกับ Technology เเละ การCoding</p>
