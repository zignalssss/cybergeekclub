							...
							<div tabIndex={0} role="button" className='flex group '>
								<div className="avatar">
									<div className="transition-all duration-250 group-hover:drop-shadow-[0_0_10px_rgba(22,101,52)] w-7mt-2 md:w-10 rounded-full ring-2 ring-green-400 drop-shadow-[0_0_4px_rgba(22,101,52)]">
										{userData ? <img alt='profile' src={userData.profile_image? `${userData.profile_image}`:`https://firebasestorage.googleapis.com/v0/b/cybergeek-storage-image.appspot.com/o/blank-profile-picture-973460_1280.png?alt=media&token=8e0b08a9-2543-402a-bf86-2b500557f9eb`} width={16} height={16}/> : <div className="skeleton w-16 h-16 rounded-full shrink-0"></div>}	
									</div>
								</div>
